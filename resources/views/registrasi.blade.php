        ...
        <div class="container">
            ...
            <form action="{{ url('postregistrasi') }}" method="post">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" id="username" placeholder="calculus">
                </div>
                <div>
                    <label for="email" class="col-sm-2 col-form-label"><b>Email</b></label>
                    <input type="text" class="form-control" id="email" placeholder="calculus@gmail.com">
                </div>
                <div>
                    <label for="name" class="col-sm-2 col-form-label"><b>Name</b></label>
                    <input type="text" class="form-control" id="name" placeholder="Calculus">
                </div>
                <div>
                    <label for="password" class="col-sm-2 col-form-label"><b>Password</b></label>
                    <input type="text" class="form-control" id="password" placeholder="Input password">
                </div>
                <div>
                    <label for="date_of_birth" class="col-sm-5 col-form-label"><b>Date of Birth</b></label>
                    <input type="date" class="form-control" id="date_of_birth" placeholder="Select a date">
                </div>
                <fieldset>
